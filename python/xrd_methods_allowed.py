...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='X-Road allowedMethods request.',
    ...
    for method in xrdinfo.methods(addr=args.url, client=client, service=service, method='allowedMethods', timeout=timeout, verify=verify, cert=cert):
